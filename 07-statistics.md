...
P(Identical Twins & Twin Brother) = P(Both Boys|Identical Twins)*P(Identical Twins) = 1/300*1/2

P(Fraternal Twins & Twin Brother) = P(Both Boys|Fraternal Twins)xP(Fraternal Twins) = 1/125x1/4

P(Identical Twins|Twin Brother) = P(Identical Twins & Twin Brother)/P(Twin Brother)

P(Identical Twins|Twin Brother) = (1/2x1/300)/(1/2x1/300 + 1/4x1/125)
...
*Both Bayesian and Frequentist are approaches to evaluating evidence about competing hypotheses.* 

**Bayesian**

*Uses probabilities for both hypotheses and data

*Depends on a prior and likelihood for observed data

*Requires a prior, i.e. *apriori* knowledge about the probability of the hypothesis

*May be computationally intensive due to integration over many parameters

**Frequentist**

*Never uses a proobability for the hypothesis (prior or posterior)
